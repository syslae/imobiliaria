<?php
	...
	if (empty($erro))
	{
		class Logacesso extends ADOdb_Active_Record
		{
			var $_table = "logacesso";
		}
		$obj = new Logacesso();
		
		//echo "<p>Atributos da tabela: ";
		//var_dump($logacesso->getAttributeNames());
		...
		{
			echo "Ocorreu uma execao do tipo ADODB_Exception no modulo de salvar logacesso";
		}
		catch(exceptions $e)
		{
			//echo $e->getMessage();
			echo "Ocorreu uma execao no modulo de salvar logacesso";
		}
	}
?>