...
//############################################
	...
	function retornaFilhosRequisicao($id=NULL)
	{
		...
		else
		{
			...
			#somente <descricao> na visualizaçao dos items ja adicionados
			#e <codigo>
			##############################################################
			...
			$rs=$DB->Execute($sql);
				...
				echo '<div id="filho'.$rs->fields["produto_id"].'">Produto:'.$rs->fields["nome_produto"].'<br>Quantidade:'.$rs->fields["quantidade"].' Valor unitário: R$ '.moeda($rs->fields["valor_total"]).'
