<? session_start();
	...
	$campos = "id,produto_id,transferencia_id,setor_id,tipo_requisicao_id,situacao_requisicao_id,saida_id,tombo_id,unidade_medida_id,prioridade_id,requisicao_id,entrada_id,quantidade_autorizada,quantidade_final,descricao_produto,quantidade_requisitada,valor_total,created,status";
