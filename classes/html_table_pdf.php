...
function Footer()
{
	...
	//$this->Cell(1,10,'__________________________________________________',0,0,'L');
	$this->Cell(130);
	...
	//$this->Cell(1,10,'Assinatura do Coordenador do Curso',0,0,'L');
	$this->Cell(50);
	$this->Cell(1,10,'Página '.$this->PageNo().'',0,1,'C');
	//$this->Cell(1,10,'Assinatura do Professor',0,0,'L');
	$this->Ln(4);
	$this->Cell(130);
	//$this->Cell(1,10,'Página '.$this->PageNo().'',0,1,'C');
	$this->Ln(10);
