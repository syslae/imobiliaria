<? session_start();
	...
	{
		include(DOMAIN_PATH."core/model/cnd_federal.Model.php");
		include(DOMAIN_PATH."core/controller/cnd_federal.Controller.php");
	}
	else if (!empty($id))
	{
		include(DOMAIN_PATH."core/atualizar/cnd_federal.Atualizar.php");
	}
	else
	{
