<? session_start();
	...
	{
		include(DOMAIN_PATH."core/model/icms.Model.php");
		include(DOMAIN_PATH."core/controller/icms.Controller.php");
	}
	else if (!empty($id))
	{
		include(DOMAIN_PATH."core/atualizar/icms.Atualizar.php");
	}
	else
	{
