<? session_start();
	...
	{
		include(DOMAIN_PATH."core/model/contrato.Model.php");
		include(DOMAIN_PATH."core/controller/contrato.Controller.php");
	}
	else if (!empty($id))
	{
		include(DOMAIN_PATH."core/atualizar/contrato.Atualizar.php");
	}
	else
	{
