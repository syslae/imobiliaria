<? session_start();
	...
	{
		include(DOMAIN_PATH."core/model/cartao_cnpj.Model.php");
		include(DOMAIN_PATH."core/controller/cartao_cnpj.Controller.php");
	}
	else if (!empty($id))
	{
		include(DOMAIN_PATH."core/atualizar/cartao_cnpj.Atualizar.php");
	}
	else
	{
