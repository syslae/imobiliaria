<? session_start();
	...
	{
		include(DOMAIN_PATH."core/model/usuarios.Model.php");
		include(DOMAIN_PATH."core/controller/usuarios.Controller.php");
	}
	else if (!empty($id))
	{
		include(DOMAIN_PATH."core/atualizar/usuarios.Atualizar.php");
	}
	else
	{
