                                    ...
                                    <td align="center" valign="top">
                                         ...
                                         <table width="830" border="0" cellspacing="0" cellpadding="0" class="bordaPesquisa" style="margin:5px" >
                                            <tr>
                                             ...
                                             <tr>
                                                 <td colspan="3" align="center"><strong>Filtro cliente:</strong><input  type="radio" name="filtro_cliente" value="1" onclick="carregaInputCliente(1)"/>Sim  <input  type="radio" name="filtro_cliente" value="2" onclick="carregaInputCliente(2)"/>Não   <!--   <strong>Filtro mês/ano :</strong><input  type="radio" name="filtro_mes" value="1" onclick="carregaInputMesReferencia(1)"/>Sim  <input  type="radio" name="filtro_mes" value="2" onclick="carregaInputMesReferencia(2)"/>Não--!> <strong>Serviço:</strong><input  type="radio" name="filtro_servico" value="1" onclick="carregaInputServico(1)"/>Sim  <input  type="radio" name="filtro_servico" value="2" onclick="carregaInputServico(2)"/>Não</td>
                                             </tr>
                                <tr> 
                                    <td align="center" valign="top">
                                        ...
                                        <table width="830" border="0" cellspacing="0" cellpadding="0" id="mes_referencia" class="bordaPesquisa" style="margin:5px" >
                                             <td colspan="3" align="center" height="50">Mês /Ano  
                                              <?
													$dados = array('primary_key' => 'id', 
													'nome' => 'mes',
                                                  	'tabela' => 'meses', 
                                      ...
                                      <table width="830" border="0" cellspacing="0" cellpadding="0" id="servico" class="bordaPesquisa" style="margin:5px" >
                                             <td colspan="3" align="center" height="50">Serviço
                                              <?
												    $dados = array('primary_key' => 'id', 
													'nome' => 'descricao', 
													'tabela' => 'servico', 
