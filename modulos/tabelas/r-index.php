<table width="830" border="0" cellspacing="0" cellpadding="2">
					...
					<tr>
						<td class="acoes-index" align="left" width="57">Acoes</td> 
	                    <td align="left" class="acoes-index">tabela_id</td> 
	                    <td align="left" class="acoes-index">menu_id</td> 
	                    <td align="left" class="acoes-index">nome</td> 
	                    <td align="left" class="acoes-index">tipo</td> 
	                    <td align="left" class="acoes-index">pasta</td> 
	                    <td align="left" class="acoes-index">status</td> 
	                    <td width="68" align="left" class="acoes-index">Del</td>
...

						{
...

							{
...

								{
									...
									$status = '<img id="img-'.$posicao.'" name="img-'.$posicao.'" src="../../webroot/img_sistema/bola-verde.gif" onclick="javascript:atualizaStatus('.$posicao.',0,'.$rs->fields['id'].',\'tabelas\');"  border="0">';
...

								{
									...
									$status = '<img id="img-'.$posicao.'" name="img-'.$posicao.'" src="../../webroot/img_sistema/bola-vermelha.gif" onclick="javascript:atualizaStatus('.$posicao.',1,'.$rs->fields['id'].',\'tabelas\');"  border="0">';
							...
							<tr bgcolor="'.$bg.'">
	                            ...
	                            <td class="text_padrao">'.$rs->fields['tabela_id'].'</td> 
	                            <td class="text_padrao">'.$rs->fields['menu_id'].'</td> 
	                            <td class="text_padrao">'.$rs->fields['nome'].'</td> 
	                            <td class="text_padrao">'.$rs->fields['tipo'].'</td> 
	                            <td class="text_padrao">'.$rs->fields['pasta'].'</td> 
