<? session_start();
	...
	$campos = "id,tabela_id,menu_id,nome,tipo,pasta,status";
                            ...
                            <table width="100%" border="0" cellspacing="6" cellpadding="0">
                                ...
                                <tr> 
									...
									<table width="830" border="0" cellspacing="0" cellpadding="0" style="margin-top:20px;margin-bottom:20px;">
                                        <tr>
                                            <td class="text_bold_vermelho" style="text-align:center; font-size:14px;" height="50" valign="middle">N&atilde;o existem resultados</td>
                                        </tr>
                                    </table>
                                    <?
                                    }
