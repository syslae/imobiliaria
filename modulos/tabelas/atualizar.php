<? session_start();
	...
	{
		include(DOMAIN_PATH."core/model/tabelas.Model.php");
		include(DOMAIN_PATH."core/controller/tabelas.Controller.php");
	}
	else if (!empty($id))
	{
		include(DOMAIN_PATH."core/atualizar/tabelas.Atualizar.php");
	}
	else
	{
                                ...
                                <tr> 
                                    ...
                                    <form action="<? echo $GLOBALS["paginaAtual"]?>"  name="form" method="post" enctype="multipart/form-data">				
                                         <table width="830" border="0" cellspacing="2" cellpadding="0" class="borda" style="margin:5px" >
                                            ...
                                            <? if (!empty($erro)) {?>
                                            <tr align="center"> 
                                                <td colspan="2" class="text_bold_vermelho">Desculpe, &eacute; necess&aacute;rio preencher corretamente os campos em destaque.</td>
                                            </tr>
                                            <? }?>
                                            <tr>
