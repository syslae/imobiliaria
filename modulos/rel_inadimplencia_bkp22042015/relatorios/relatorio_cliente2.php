...
class PDF extends FPDF
{
	...
	function Header()
	{
        ...
        $tituloRel = 'Relatório de Inadimplência';
...
//Instancia da Classe
    ...
    $pdf->Row(array("Nome","Cpf","Parcela", "Valor", "Data de Vencimento"),array("L","L","L","L","L");
    $pdf->SetFont('Arial','',8);
    ...
    while (!$rs->EOF)
	{
     ...
     $pdf->Row(array("$nome","$cpf","$valor ","$data_vencimento "),array("L","L","L","L","L"));				
