<? session_start();
	...
	{
		include(DOMAIN_PATH."core/model/simples_nacional.Model.php");
		include(DOMAIN_PATH."core/controller/simples_nacional.Controller.php");
	}
	else if (!empty($id))
	{
		include(DOMAIN_PATH."core/atualizar/simples_nacional.Atualizar.php");
	}
	else
	{
