						...
						while (!$rs->EOF)
						{
							...
							<tr bgcolor="'.$bg.'">
								...
								<td>';
					                ...
					                if (!empty($_SESSION["permissao_temp"])) echo '<a href="../../upload/simples_nacional/'.$id.'.pdf" target="_blank"><img src="../../webroot/img_sistema/anexo.png" border="0"></a>&nbsp;&nbsp;';
							...
							echo '</td>
                                 ...
                                 <td class="text_padrao">'.retornaNome('meses','mes',$rs->fields['mes']).'</td>
	                             <td class="text_padrao">'.retornaNome('ano','ano',$rs->fields['ano']).'</td>
	                             <td class="text_padrao">'.moeda($rs->fields['valor']).'</td>
	                             <td class="text_padrao">'.retornaNome('usuarios', 'nome', $rs->fields['usuario_id']).'</td>
                               	 <td>'; botaoCheckbox($rs->fields['id']);echo '&nbsp;</td>
							 </tr>
