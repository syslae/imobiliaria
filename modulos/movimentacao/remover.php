                                            ...
                                            <td width="746" align="center" class="text_bold_azul">
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        <form name="remover" method="post" action="">
                                                            <table align="center" width="500" border="0" cellspacing="0" cellpadding="0"> 
                                                                ...
                                                                foreach ($c as $value) 
                                                                {
                                                                 $sql = "select id, usuario_id from $tabela where id = $value";
                                                                 $result = $DB->Execute($sql);
                                                                ?>
                                                                <tr>
                                                                    <td class="text_bold_preto"> 
                                                                        <strong><?=retornaNome('usuarios','nome',$result->fields['usuario_id'])?></strong>
                                                ...
                                                if (isset ($_POST['deletar']))
                                                {
                                                    ...
                                                    {					
                                                        ...
                                                        $result = $DB->Execute($sql);
                                                        $sql2 = "update  itens set status = 0 where pedido_id = $c[0]";
                                                        $result = $DB->Execute($sql2);
                                                        $sql = "update  $tabela set status = 0 where id = $value";
                                                        if ($DB->Execute($sql) === false) print 'Erro no delete';
                                                        else echo '<center>Registro # '.$value.' # apagado do Banco de Dados</center><br><br>';
                                                    }
