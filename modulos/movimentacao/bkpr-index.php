<table width="830" id="box-table-a" cellspacing="0" cellpadding="2">
				<thead>
					<tr>
                        ...
                        <th width="80" style="text-align:center">Orçamento</th>
						...
						while (!$rs->EOF)
						{
							...
							<tr bgcolor="'.$bg.'">
								...
								if (!empty($_SESSION["permissao_temp"])) echo '<a href="visualizar.php?id='.$id.'"><img src="../../webroot/img_sistema/magnifier.png" border="0" alt="Visualizar" title="Visualizar" /></a>&nbsp;&nbsp;';
                                 ...
                                 botaoEditarPedido($rs->fields['id']);   
							...
							echo '</td>
	                            ...
	                            <td class="text_padrao">'.$rs->UserTimeStamp($rs->fields['data_pedido'],'d-m-Y').'</td>
                                <td class="text_padrao" align="center">'.VerificaOrcamento($id).'</td>  
	                            <td align="center">'; botaoCheckboxPedido($rs->fields['id']);echo '&nbsp;</td>
