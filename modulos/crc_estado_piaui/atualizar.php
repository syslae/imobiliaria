<? session_start();
	...
	verifica ("../../login.php");
	###        CONFIGURACAO        ###
	$tabela = 'crc_estado_piaui';
	$id = (int)$_GET['id'];
	$modulo = "CRC ESTADO PIAUI";
	$tabela_id=119;
	
	if(isset($_POST['acao']) && $_POST['acao']=='atualizar')
	{
		include(DOMAIN_PATH."core/model/crc_estado_piaui.Model.php");
		include(DOMAIN_PATH."core/controller/crc_estado_piaui.Controller.php");
	}
	else if (!empty($id))
	{
		include(DOMAIN_PATH."core/atualizar/crc_estado_piaui.Atualizar.php");
	}
	else
	{
