<? session_start();
	...
	$criterio = " where 1=1 ".$criterio1." and espaco_fisico_id=".$_SESSION["espaco_fisico_id"]." and produto_principal_id is null  order by id desc";
	$campos = "id,descricao,espaco_fisico_id,created,status";
