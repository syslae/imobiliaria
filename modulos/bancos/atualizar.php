<? session_start();
	...
	{
		include(DOMAIN_PATH."core/model/bancos.Model.php");
		include(DOMAIN_PATH."core/controller/bancos.Controller.php");
	}
	else if (!empty($id))
	{
		include(DOMAIN_PATH."core/atualizar/bancos.Atualizar.php");
	}
	else
	{
