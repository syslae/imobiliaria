...
{
    include(DOMAIN_PATH."core/model/baixa.Model.php");
    include(DOMAIN_PATH."core/controller/baixa.Controller.php");
}
...
$data_inicioPP = $data_fimPP = date('d/m/Y');
                                                ...
                                                <td colspan="2" width="330" >
                                                    <div class="message error">
                                                        <p> <strong> Desculpe, &eacute; necess&aacute;rio preencher corretamente os campos em destaque.
                                                            Verifique se você informou o cliente, as parcelas.</strong></p>
                                                    </div>
                                                </td>
                                            </tr>
                                            <? }
                                            ...
                                            <tr align="center">
                                                <td colspan="2" width="330" >
                                                    <div class="message warning">
                                                        <p> <strong> O acesso a tela somente será liberado após o cadastro da situação pagamento 'PAGO' com status ativo.
