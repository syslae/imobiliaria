<? session_start();
	...
	###        CONFIGURACAO        ###
	$tabela = "baixa b
inner join parcelas p on p.id = b.parcela_id
inner join usuarios u on u.id = b.usuario_id";
	...
	$criterio = " where 1=1 ".$criterio1." order by b.id desc";
    $campos = "b.id,p.parcela,p.data_vencimento,p.nosso_numero,b.data_baixa,b.valor, b.tela,b.usuario_id,u.nome,b.created";
	
    $campos_filtro = array('b.id' => 'id',
        'p.nosso_numero' => 'nossonumero',
        'b.tela' => 'motivo',
        'b.usuario_id' => 'id usuário',
        'u.nome' => 'nome usuário',
        'b.created' => 'data');
