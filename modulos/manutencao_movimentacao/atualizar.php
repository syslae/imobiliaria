<? session_start();
	...
	{
		include(DOMAIN_PATH."core/model/manutencao_movimentacao.Model.php");
		include(DOMAIN_PATH."core/controller/manutencao_movimentacao.Controller.php");
	}
	else if (!empty($id))
	{
		include(DOMAIN_PATH."core/atualizar/manutencao_movimentacao.Atualizar.php");
	}
	else
	{
