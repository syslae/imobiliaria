					...
					else
					{
						...
						while (!$rs->EOF)
						{
							...
							if (($_SESSION["permissao_temp"]>1))
							{
								...
								{
									$status = '<img id="img-'.$posicao.'" name="img-'.$posicao.'" src="../../webroot/img_sistema/bola-verde.gif" onclick="javascript:atualizaStatus('.$posicao.',0,'.$rs->fields['id'].',\'fornecedor\');"  border="0">';
								}
								else
								{
									$status = '<img id="img-'.$posicao.'" name="img-'.$posicao.'" src="../../webroot/img_sistema/bola-vermelha.gif" onclick="javascript:atualizaStatus('.$posicao.',1,'.$rs->fields['id'].',\'fornecedor\');"  border="0">';
								}
							}
							else
							{
							...
							echo '</td>
                                ...
                                <td class="text_padrao">'.$rs->fields['nome_fantasia'].'</td> 
	                            ...
	                            <td class="text_padrao">'.$rs->fields['atuacao'].'</td>       
