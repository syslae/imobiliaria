<? session_start();
	...
	{
		include(DOMAIN_PATH."core/model/empresa.Model.php");
		include(DOMAIN_PATH."core/controller/empresa.Controller.php");
	}
	else if (!empty($id))
	{
		include(DOMAIN_PATH."core/atualizar/empresa.Atualizar.php");
	}
	else
	{
