<? session_start();
	...
	{
		include(DOMAIN_PATH."core/model/inss.Model.php");
		include(DOMAIN_PATH."core/controller/inss.Controller.php");
	}
	else if (!empty($id))
	{
		include(DOMAIN_PATH."core/atualizar/inss.Atualizar.php");
	}
	else
	{
