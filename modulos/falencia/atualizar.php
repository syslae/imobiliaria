<? session_start();
	...
	$tabela = 'falencia';
	$id = (int)$_GET['id'];
	$modulo = "FALÊNCIA CONCORDATA";
	$tabela_id=110;
	
	if(isset($_POST['acao']) && $_POST['acao']=='atualizar')
	{
		include(DOMAIN_PATH."core/model/falencia.Model.php");
		include(DOMAIN_PATH."core/controller/falencia.Controller.php");
	}
	else if (!empty($id))
	{
		include(DOMAIN_PATH."core/atualizar/falencia.Atualizar.php");
	}
	else
	{
