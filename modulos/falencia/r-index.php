					...
					else
					{
						...
						while (!$rs->EOF)
						{
							...
							if (($_SESSION["permissao_temp"]>1))
							{
								...
								{
									$status = '<img id="img-'.$posicao.'" name="img-'.$posicao.'" src="../../webroot/img_sistema/bola-verde.gif" onclick="javascript:atualizaStatus('.$posicao.',0,'.$rs->fields['id'].',\'falencia\');"  border="0">';
								}
								else
								{
									$status = '<img id="img-'.$posicao.'" name="img-'.$posicao.'" src="../../webroot/img_sistema/bola-vermelha.gif" onclick="javascript:atualizaStatus('.$posicao.',1,'.$rs->fields['id'].',\'falencia\');"  border="0">';
								}
							}
							else
							{
							...
							<tr bgcolor="'.$bg.'">
								...
								<td align="center">';
                           if (!empty($_SESSION["permissao_temp"])) echo '<a href="../../upload/falencia/'.$id.'.pdf" target="_blank"><img src="../../webroot/img_sistema/anexo.png" border="0"></a>&nbsp;&nbsp;';
