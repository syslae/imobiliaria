<? session_start();
	...
	{
		include(DOMAIN_PATH."core/model/ferias.Model.php");
		include(DOMAIN_PATH."core/controller/ferias.Controller.php");
	}
	else if (!empty($id))
	{
		include(DOMAIN_PATH."core/atualizar/ferias.Atualizar.php");
	}
	else
	{
