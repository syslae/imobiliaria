						...
						while (!$rs->EOF)
						{
							...
							<tr bgcolor="'.$bg.'">
								...
								<td align="center">';
					                ...
					                if (!empty($_SESSION["permissao_temp"])) echo '<a href="../../upload/ferias/'.$id.'.pdf" target="_blank"><img src="../../webroot/img_sistema/anexo.png" border="0"></a>&nbsp;&nbsp;';
							...
							echo '</td>
                                 ...
                                 <td class="text_padrao">'.$rs->UserTimeStamp($rs->fields['data_inicio'],'d-m-Y').'</td>
                               <td class="text_padrao">'.$rs->UserTimeStamp($rs->fields['data_fim'],'d-m-Y').'</td>
