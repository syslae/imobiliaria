<? session_start();
	...
	$id = (int)$_GET['id'];
	$modulo = "INSCRIÇÃO ESTADUAL";
	$tabela_id=119;
	
	if(isset($_POST['acao']) && $_POST['acao']=='atualizar')
	{
		include(DOMAIN_PATH."core/model/i_e.Model.php");
		include(DOMAIN_PATH."core/controller/i_e.Controller.php");
	}
	else if (!empty($id))
	{
		include(DOMAIN_PATH."core/atualizar/i_e.Atualizar.php");
	}
	else
	{
