<? session_start();
	...
	{
		include(DOMAIN_PATH."core/model/rescisao.Model.php");
		include(DOMAIN_PATH."core/controller/rescisao.Controller.php");
	}
	else if (!empty($id))
	{
		include(DOMAIN_PATH."core/atualizar/rescisao.Atualizar.php");
	}
	else
	{
...
<script type="text/javascript" charset="utf-8">
		$(function()
		{
              $('#data').datePicker({startDate:'01/2012'});
	       });
