<? session_start();
	...
	verifica ("../../login.php");
	###        CONFIGURACAO        ###
	$tabela = 'incricao_municipal';
	$id = (int)$_GET['id'];
	$modulo = "INSCRIÇÃO MUNICIPAL";
	$tabela_id=119;
	
	if(isset($_POST['acao']) && $_POST['acao']=='atualizar')
	{
		include(DOMAIN_PATH."core/model/i_m.Model.php");
		include(DOMAIN_PATH."core/controller/i_m.Controller.php");
	}
	else if (!empty($id))
	{
		include(DOMAIN_PATH."core/atualizar/i_m.Atualizar.php");
	}
	else
	{
