<? session_start();
	...
	$tabela = 'cnd_estadual';
	$id = (int)$_GET['id'];
	$modulo = "CND ESTADUAL DIVIDA ATIVA ";
	$tabela_id=105;
	

    if(isset($_POST['acao']) && $_POST['acao']=='atualizar')
	{
        include(DOMAIN_PATH."core/model/cnd_estadual.Model.php");
		include(DOMAIN_PATH."core/controller/cnd_estadual.Controller.php");
	}
	else if (!empty($id))
	{
    	include(DOMAIN_PATH."core/atualizar/cnd_estadual.Atualizar.php");
	}
	else
	{
