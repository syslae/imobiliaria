<? session_start();
	...
	{
		include(DOMAIN_PATH."core/model/crc_sicaf.Model.php");
		include(DOMAIN_PATH."core/controller/crc_sicaf.Controller.php");
	}
	else if (!empty($id))
	{
		include(DOMAIN_PATH."core/atualizar/crc_sicaf.Atualizar.php");
	}
	else
	{
