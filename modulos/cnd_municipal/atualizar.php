<? session_start();
	...
	verifica ("../../login.php");
	###        CONFIGURACAO        ###
	$tabela = 'cnd_municipal';
	$id = (int)$_GET['id'];
	$modulo = "CND MUNICIPAL";
	$tabela_id=106;
	
	if(isset($_POST['acao']) && $_POST['acao']=='atualizar')
	{
		include(DOMAIN_PATH."core/model/cnd_municipal.Model.php");
		include(DOMAIN_PATH."core/controller/cnd_municipal.Controller.php");
	}
	else if (!empty($id))
	{
		include(DOMAIN_PATH."core/atualizar/cnd_municipal.Atualizar.php");
	}
	else
	{
