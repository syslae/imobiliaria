<? session_start();
	...
	verifica ("../../login.php");
	###        CONFIGURACAO        ###
	$tabela = 'extrato_simples';
	$id = (int)$_GET['id'];
	$modulo = "Extrato Simples";
	$tabela_id=139;

	if(isset($_POST['acao']) && $_POST['acao']=='atualizar')
	{
		include(DOMAIN_PATH."core/model/extrato_simples.Model.php");
		include(DOMAIN_PATH."core/controller/extrato_simples.Controller.php");
	}
	else if (!empty($id))
	{
		include(DOMAIN_PATH."core/atualizar/extrato_simples.Atualizar.php");
	}
	else
	{
