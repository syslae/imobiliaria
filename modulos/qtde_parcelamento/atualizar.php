<? session_start();
	...
	{
		include(DOMAIN_PATH."core/model/qtde_parcelamento.Model.php");
		include(DOMAIN_PATH."core/controller/qtde_parcelamento.Controller.php");
	}
	else if (!empty($id))
	{
		include(DOMAIN_PATH."core/atualizar/qtde_parcelamento.Atualizar.php");
	}
	else
	{
