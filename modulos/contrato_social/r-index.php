					...
					else
					{
						...
						while (!$rs->EOF)
						{
							...
							<tr bgcolor="'.$bg.'">
					         ...
					         if (!empty($_SESSION["permissao_temp"])) echo '<a href="../../modulos/contrato_social/upload.php?id='.$rs->fields['id'].'&height=40&width=800&keepThis=true&TB_iframe=true" title="Contrato Social" class="thickbox"" target="_blank"><img src="../../webroot/img_sistema/anexo.png" border="0"></a>';
