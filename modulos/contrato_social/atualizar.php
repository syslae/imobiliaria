<? session_start();
	...
	verifica ("../../login.php");
	###        CONFIGURACAO        ###
	$tabela = 'contrato_social';
	$id = (int)$_GET['id'];
	$modulo = "CONTRATO SOCIAL";
	$tabela_id=130;
	
	if(isset($_POST['acao']) && $_POST['acao']=='atualizar')
	{
		include(DOMAIN_PATH."core/model/contrato_social.Model.php");
		include(DOMAIN_PATH."core/controller/contrato_social.Controller.php");
	}
	else if (!empty($id))
	{
		include(DOMAIN_PATH."core/atualizar/contrato_social.Atualizar.php");
	}
	else
	{
