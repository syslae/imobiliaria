<? session_start();
	...
	{
		include(DOMAIN_PATH."core/model/balanco_patrimonial.Model.php");
		include(DOMAIN_PATH."core/controller/balanco_patrimonial.Controller.php");
	}
	else if (!empty($id))
	{
		include(DOMAIN_PATH."core/atualizar/balanco_patrimonial.Atualizar.php");
	}
	else
	{
