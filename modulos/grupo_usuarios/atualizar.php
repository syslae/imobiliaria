<? session_start();
	...
	{
		include(DOMAIN_PATH."core/model/grupo_usuarios.Model.php");
		include(DOMAIN_PATH."core/controller/grupo_usuarios.Controller.php");
	}
	else if (!empty($id))
	{
		include(DOMAIN_PATH."core/atualizar/grupo_usuarios.Atualizar.php");
	}
	else
	{
