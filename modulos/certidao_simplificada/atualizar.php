<? session_start();
	...
	verifica ("../../login.php");
	###        CONFIGURACAO        ###
	$tabela = 'certidao_simplificada';
	$id = (int)$_GET['id'];
	$modulo = "CERTIDÃO SIMPLIFICADA";
	$tabela_id=127;
	
	if(isset($_POST['acao']) && $_POST['acao']=='atualizar')
	{
		include(DOMAIN_PATH."core/model/certidao_simplificada.Model.php");
		include(DOMAIN_PATH."core/controller/certidao_simplificada.Controller.php");
	}
	else if (!empty($id))
	{
		include(DOMAIN_PATH."core/atualizar/certidao_simplificada.Atualizar.php");
	}
	else
	{
