<? session_start();
	...
	{
		include(DOMAIN_PATH."core/model/iss.Model.php");
		include(DOMAIN_PATH."core/controller/iss.Controller.php");
	}
	else if (!empty($id))
	{
		include(DOMAIN_PATH."core/atualizar/iss.Atualizar.php");
	}
	else
	{
