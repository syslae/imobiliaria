<? session_start();
	...
	{
		include(DOMAIN_PATH."core/model/irpj.Model.php");
		include(DOMAIN_PATH."core/controller/irpj.Controller.php");
	}
	else if (!empty($id))
	{
		include(DOMAIN_PATH."core/atualizar/irpj.Atualizar.php");
	}
	else
	{
