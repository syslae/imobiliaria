<? session_start();
	...
	{
		include(DOMAIN_PATH."core/model/novo_fgts.Model.php");
		include(DOMAIN_PATH."core/controller/novo_fgts.Controller.php");
	}
	else if (!empty($id))
	{
		include(DOMAIN_PATH."core/atualizar/novo_fgts.Atualizar.php");
	}
	else
	{
