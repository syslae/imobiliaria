<? session_start();
	...
	{
		include(DOMAIN_PATH."core/model/fgts.Model.php");
		include(DOMAIN_PATH."core/controller/fgts.Controller.php");
	}
	else if (!empty($id))
	{
		include(DOMAIN_PATH."core/atualizar/fgts.Atualizar.php");
	}
	else
	{
