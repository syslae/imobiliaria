<? session_start();
	...
	verifica ("../../login.php");
	###        CONFIGURACAO        ###
	$tabela = 'cnd_estadual_negativa';
	$id = (int)$_GET['id'];
	$modulo = "CND ESTADUAL NEGATIVA";
	$tabela_id=112;
    
  	if(isset($_POST['acao']) && $_POST['acao']=='atualizar')
	{
		include(DOMAIN_PATH."core/model/cnd_estadual_negativa.Model.php");
		include(DOMAIN_PATH."core/controller/cnd_estadual_negativa.Controller.php");
	}
	else if (!empty($id))
	{
		include(DOMAIN_PATH."core/atualizar/cnd_estadual_negativa.Atualizar.php");
	}
	else
	{
