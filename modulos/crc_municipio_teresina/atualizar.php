<? session_start();
	...
	verifica ("../../login.php");
	###        CONFIGURACAO        ###
	$tabela = 'crc_municipio_teresina';
	$id = (int)$_GET['id'];
	$modulo = "CRC MUNICIPIO TERESINA";
	$tabela_id=125;
	
	if(isset($_POST['acao']) && $_POST['acao']=='atualizar')
	{
		include(DOMAIN_PATH."core/model/crc_municipio_teresina.Model.php");
		include(DOMAIN_PATH."core/controller/crc_municipio_teresina.Controller.php");
	}
	else if (!empty($id))
	{
		include(DOMAIN_PATH."core/atualizar/crc_municipio_teresina.Atualizar.php");
	}
	else
	{
