                                    ...
                                    <td align="center" valign="top">
                                         ...
                                         <table width="830" border="0" cellspacing="0" cellpadding="0" class="bordaPesquisa" style="margin:5px" >
                                            <tr>
                                             ...
                                             <tr>
                                                 <td colspan="3" align="center"><strong>Selecionar Empresa:</strong><input  type="radio" name="filtro_empresa" value="1" onclick="carregaInputCliente(1)"/>Sim  <input  type="radio" name="filtro_empresa" value="2" onclick="carregaInputCliente(2)"/>Não</td>
                                             </tr>
                                <tr>
                                    <td align="center" valign="top">
                                         <table width="830" border="0" cellspacing="0" id="cliente" cellpadding="0" class="bordaPesquisa" style="margin:5px" >
                                            <tr>
                                                <td colspan="4" align="center" height="50">Empresa:
                                                  <?
