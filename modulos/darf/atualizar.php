<? session_start();
	...
	{
		include(DOMAIN_PATH."core/model/darf.Model.php");
		include(DOMAIN_PATH."core/controller/darf.Controller.php");
	}
	else if (!empty($id))
	{
		include(DOMAIN_PATH."core/atualizar/darf.Atualizar.php");
	}
	else
	{
