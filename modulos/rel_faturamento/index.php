                                    ...
                                    <td align="center" valign="top">
                                         ...
                                         <table width="830" border="0" cellspacing="0" cellpadding="0" class="bordaPesquisa" style="margin:5px" >
                                            <tr>
                                             ...
                                             <tr>
                                                 <td colspan="3" align="center"><strong>Filtro cliente:</strong><input  type="radio" name="filtro_cliente" value="1" onclick="carregaInputCliente(1)"/>Sim  <input  type="radio" name="filtro_cliente" value="2" onclick="carregaInputCliente(2)"/>Não     <strong>Filtro mês/ano referência:</strong><input  type="radio" name="filtro_mes" value="1" onclick="carregaInputMesReferencia(1)"/>Sim  <input  type="radio" name="filtro_mes" value="2" onclick="carregaInputMesReferencia(2)"/>Não</td>
                                             </tr>
                                             <tr>
                                                 <td colspan="3" align="center"><strong>Filtro N° PD:</strong> <input  type="radio" name="filtro_npd" value="3" />Todos <input  type="radio" name="filtro_npd" value="1" />Sim  <input  type="radio" name="filtro_npd" value="2"/>Não</td>
                                             </tr>
                                <tr> 
                                    <td align="center" valign="top">
                                        ...
                                        <table width="830" border="0" cellspacing="0" cellpadding="0" id="mes_referencia" class="bordaPesquisa" style="margin:5px" >
                                             <td colspan="3" align="center" height="50">Mês /Ano  Referência
                                              <?
													$dados = array('primary_key' => 'id', 
													'nome' => 'mes',
                                                  	'tabela' => 'meses', 
                                      ...
                                      <table width="830" border="0" cellspacing="0" cellpadding="0" class="bordaPesquisa" style="margin:5px" >
                                                 <tr>
                                                <td colspan="4" align="center" height="50">  <input  type="radio" name="tipo" value="todos"/>Todos <input  type="radio" name="tipo" value="pago"/>Pago  <input  type="radio" name="tipo" value="naopago"/>Não Pago</td>
                                             </tr>
                                             <tr align="center">
