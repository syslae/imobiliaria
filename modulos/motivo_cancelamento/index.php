<? session_start();
	...
	###        CONFIGURACAO        ###
	$tabela = "motivo_cancelamento mc
inner join parcelas p on p.id = mc.parcela_id
inner join usuarios u on u.id = mc.usuario_id ";
	...
	$criterio = " where 1=1 ".$criterio1." order by mc.id desc";
	$campos = "mc.id,p.nosso_numero,mc.motivo,mc.usuario_id,u.nome,mc.created ";
    $campos_filtro = array('mc.id' => 'id',
        'p.nosso_numero' => 'nossonumero',
        'mc.motivo' => 'motivo',
        'mc.usuario_id' => 'id usuário',
        'u.nome' => 'nome usuário',
        'mc.created' => 'data');
