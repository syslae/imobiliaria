<? session_start();
	...
	{
		include(DOMAIN_PATH."core/model/gps.Model.php");
		include(DOMAIN_PATH."core/controller/gps.Controller.php");
	}
	else if (!empty($id))
	{
		include(DOMAIN_PATH."core/atualizar/gps.Atualizar.php");
	}
	else
	{
